...
import { AnkiProvider } from "@/context/AnkiContext";          // ← NEW
import ThemeToggle from "@/components/ui/ThemeToggle";
import AnkiWidget from "@/components/anki/AnkiWidget";          // ← NEW
                        ...
                        <StudyPlanProvider>
                            <AnkiProvider>                      {/* ← NEW */}
                                <div className="min-h-screen flex flex-col bg-[var(--color-bg)] overflow-hidden">
                                    ...
                                    {/* ── Anki floating widget — renders on every dashboard page ── */}
                                    <AnkiWidget />                  {/* ← NEW */}
